...
import com.br.movies.exception.validationError.ValidationError;
import com.br.movies.exception.validationError.ValidationErrorResponse;
...
public class ExceptionHandlerController {
    ...
    public ResponseEntity<ErrorResponse> FilmNotFoundException(MovieNotFoundException ex) {
        ErrorResponse message = new ErrorResponse(
